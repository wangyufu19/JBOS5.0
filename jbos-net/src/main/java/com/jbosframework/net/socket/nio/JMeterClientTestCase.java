...
//
//	@Override
//	public SampleResult runTest(JavaSamplerContext com.jbosframework.boot.context) {
//		String ip=com.jbosframework.boot.context.getParameter("ip");
//		String port=com.jbosframework.boot.context.getParameter("port");
//		String message=com.jbosframework.boot.context.getParameter("message");
